        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-muted-foreground">
              <li><Link href="/marketplace" className="hover:text-primary transition-colors">All Books</Link></li>
              <li><Link href="/marketplace" className="hover:text-primary transition-colors">Engineering Dept</Link></li>
              <li><Link href="/add-listing" className="hover:text-primary transition-colors">Sell Your Books</Link></li>
